...
kops create cluster --name rahamss.k8s.local --zones ap-south-1a --control-plane-image ami-0f918f7e67a3323f0 --control-plane-count=1 --control-plane-size t2.medium --image ami-0f918f7e67a3323f0 --node-count=2 --node-size t2.micro
