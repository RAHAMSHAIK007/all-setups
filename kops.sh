...
kops create cluster --name rahamss.k8s.local --zones us-east-1a --image ami-020cba7c55df1f615  --master-count=1 --master-size t2.medium --node-count=2 --node-size t2.micro
